...
test_f4_signmask() {
    ...
    float4 r = f4_set_4xi4(0x80000000, 0, 0, 0x80000000);
...
void
test_f4_xor() {
    float4 a = f4_set_4xi4(255, 10, 0, 8);
    float4 b = f4_set_4xi4(3, 7, 0, 0x80);
    float4 c = _mm_xor_ps(a, b);
    float4 d = f4_set_4xi4(255 ^ 3, 0xa ^ 7, 0 ^ 0, 8 ^ 0x80);
    assert(f4_all_eq(c, d));
}

void
test_f4_or() {
    float4 a = f4_set_4xi4(5, 6, 7, 100);
    float4 b = f4_set_4xi4(3, 7, 0, 0x80);
    float4 c = _mm_or_ps(a, b);
    float4 d = f4_set_4xi4(5 | 3, 6 | 7, 7 | 0, 100 | 0x80);
    assert(f4_all_eq(c, d));
}
...
void
test_d4_set_i8() {
    double4 a = d4_set_4xi4(123, 456, 789, 222);
    d4_print(a, 3);
    printf("\n");
}
...
test_i4() {
    ...
    int4 reg2 = i4_set_1xi4(1);
    int4 reg3 = i4_set_4xi4(0, 1, 2, 3);
